...
namespace SmsGateway.Shared.Migrations
{
    ...
    [Migration("20260330075115_UniqueDeliverySmscIdsSmscMessageId")]
    partial class UniqueDeliverySmscIdsSmscMessageId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmsGateway.Shared.Models.DeliverySmscId", b =>
                {
                    ...
                    b.HasIndex("SmscMessageId")
                        .IsUnique()
                        .HasDatabaseName("idx_delivery_smsc_ids_smsc_message_id");
